...
const Card = ({ productData, onClickAdd, onClickFavourite, isLoading = false, btnsDisable }) => {
      ...
      <div className="product-item">
         {
            isLoading ?
               ...
               <>
                  <button disabled={btnsDisable} className={productData.favourite ? "like active" : "like"} onClick={pressFavouriteBtn}>
